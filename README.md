...
The case here shared is based on 15 March 2024 and it has been cleaned and visuaslized specific cases using Folium and others libraries. The plan is to implement more days in this project to track ship activities.
